...
import type { Database } from "@portfolio/shared-types/site";

/**
 * Server-side Supabase client for the site "brain", authenticated as
 ...
 * (see `supabase/site/README.md`) — not secrets, identical for every
